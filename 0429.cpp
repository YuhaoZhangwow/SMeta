...
//	std::thread thread1([&]() {	
	...
	for(int i=0;i<how_many;i++){
		cout<<"Working on No."<<i<<" submatrix\n";
...
//	int pTNF=gen_tnf_graph_sampleEigen(maxP,false,Meta.size(),MatrixCosMetaMeta);
	...
	cerr<<"edges from matrix are->"<<e.size()<<"\n\n";
...
// fasta.exe -meta C:\Users\okura\Downloads\testdata\2019_TBMTW-1.contigs.fa -single C:\Users\okura\Downloads\euk_test\euk_test -threshold 30 -folder C:\Users\okura\Downloads\testdata\statis
